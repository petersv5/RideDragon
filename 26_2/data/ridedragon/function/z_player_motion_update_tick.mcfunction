...
# Low speed
execute as @e[type=marker,distance=..7,tag=dragonhelper_selected,limit=1] at @s rotated ~ 0 positioned ^ ^ ^-2.6 rotated as @s run tp @e[type=ender_dragon,tag=dragonvisible_selected,limit=1,sort=nearest,distance=..7] ~ ~ ~ ~-180 ~
# High speed looking up or forward
execute if entity @s[predicate=ridedragon:book_holder_mainhand] as @e[type=marker,distance=..7,tag=dragonhelper_selected,limit=1] at @s positioned ^ ^ ^-2.7 rotated as @s run tp @e[type=ender_dragon,tag=dragonvisible_selected,limit=1,sort=nearest,distance=..7] ~ ~ ~ ~-180 ~
execute if entity @s[predicate=ridedragon:book_holder_offhand] as @e[type=marker,distance=..7,tag=dragonhelper_selected,limit=1] at @s positioned ^ ^ ^-2.7 rotated as @s run tp @e[type=ender_dragon,tag=dragonvisible_selected,limit=1,sort=nearest,distance=..7] ~ ~ ~ ~-180 ~
# High speed looking down
execute if entity @s[x_rotation=10..90,predicate=ridedragon:book_holder_mainhand] as @e[type=marker,distance=..7,tag=dragonhelper_selected,limit=1] at @s rotated ~ 0 positioned ^ ^ ^-2.7 rotated as @s positioned ^ ^ ^-2.2 rotated as @s run tp @e[type=ender_dragon,tag=dragonvisible_selected,limit=1,sort=nearest,distance=..7] ~ ~ ~ ~-180 ~
execute if entity @s[x_rotation=10..90,predicate=ridedragon:book_holder_offhand] as @e[type=marker,distance=..7,tag=dragonhelper_selected,limit=1] at @s rotated ~ 0 positioned ^ ^ ^-2.7 rotated as @s positioned ^ ^ ^-2.2 rotated as @s run tp @e[type=ender_dragon,tag=dragonvisible_selected,limit=1,sort=nearest,distance=..7] ~ ~ ~ ~-180 ~

# Offset dragon below player
#execute at @s as @e[type=ender_dragon,tag=dragonvisible_selected,limit=1,sort=nearest,distance=..7] at @s run tp @s ~ ~-0.7 ~
execute at @s as @e[type=ender_dragon,tag=dragonvisible_selected,limit=1,sort=nearest,distance=..7] at @s run function ridedragon:z_player_motion_y_offset with storage ridedragon:settings
