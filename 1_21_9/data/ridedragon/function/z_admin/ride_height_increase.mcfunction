...
scoreboard players remove #rd_math rd_help 8
scoreboard players set #rd_math rd_math_extra1 10
scoreboard players operation #rd_math rd_help /= #rd_math rd_math_extra1
execute if score #rd_math rd_help matches -20.. store result storage ridedragon:settings ride_height float 0.1 run scoreboard players get #rd_math rd_help
scoreboard players set #rd_math rd_math_extra1 0
scoreboard players operation #rd_math rd_math_extra1 -= #rd_math rd_help
execute if score #rd_math rd_help matches -20.. store result storage ridedragon:settings rd_admin.ride_height_display float 0.1 run scoreboard players get #rd_math rd_math_extra1
