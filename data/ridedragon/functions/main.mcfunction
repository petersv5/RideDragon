...
execute as @e[tag=dragonseat] at @s if entity @p[distance=..1.3,nbt={RootVehicle:{Entity:{Tags:["dragonseat"]}}}] rotated ~ 0 positioned ^ ^ ^-2.6 run execute rotated as @s run tp @e[tag=dragonvisible,limit=1,sort=nearest,distance=..4] ~ ~-0.7 ~ ~-180 ~

execute as @e[tag=dragonseat] at @s unless entity @p[distance=..1.3,nbt={RootVehicle:{Entity:{Tags:["dragonseat"]}}}] rotated ~ 0 positioned ^ ^ ^-3.5 run execute rotated as @s run tp @e[tag=dragonvisible,limit=1,sort=nearest,distance=..4] ~ ~-1.0 ~ ~-180 ~
